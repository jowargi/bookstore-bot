...
@bot.callback_query_handler(func=lambda call: call.data in ['add_100', 'add_500', 'add_1000'])
def balance_handler(call):
    ...
    replenishment_amount = int(replenishment_amount) if replenishment_amount == int(
        replenishment_amount) else replenishment_amount
