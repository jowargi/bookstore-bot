...
@bot.callback_query_handler(
    ...
    in dbhelper.get_column_values(
        db_path="./db/bookstore.db", table_name="books", column_index=0
    )
)
def catalog_handler(call):
    ...
    book_keyboard.add(
        ...
        telebot.types.InlineKeyboardButton(
            text="🛒 Добавить в корзину", callback_data="to_cart"
        ),
        telebot.types.InlineKeyboardButton(
